            ...
            <div className="mx-20">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {features.map((feature, i) => (
                        <div
                            key={i}
                            className="bg-white px-8 py-20 rounded-xl shadow transition-all duration-300 hover:bg-[#001e60] hover:text-white flex flex-col justify-between min-h-[250px]"
                        >
                            <div>
                                <Image width={100} height={100} src={feature.icon} className="w-10 h-10 mb-5" alt="icon" />
                                <h3 className="text-xl font-semibold mb-4">{feature.title}</h3>
                                <p className="mb-6 pb-20 pt-5">{feature.description}</p>
                            </div>
                            <button className="w-56 mt-auto p-10 px-4 py-2 border border-blue-700 text-blue-700 hover:bg-blue-700 hover:text-white transition-all duration-300 rounded">
                                Learn more
                            </button>
                        </div>
                    ))}
